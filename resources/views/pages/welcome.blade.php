            ...
            <div class="row">
                ...
                <div class="col-md-12 body">
                    <div class="col-sm-3 book-cover">
                        <a class="image" href="{{ route('book.show', 1) }}"><img class="image-shadow" width="100%" src="https://fsdhub.com/uploads/images/201704/28/1/O2sXyZ5ZH6.jpg"></a>
                    </div>
                    <div class="col-sm-9 book-brief">
                        ...
                        <div class="extra"><a href="{{ route('book.show', 1) }}" class="btn btn-primary btn-wider-look">了解更多</a></div>
                    </div>
                </div>
            </div>
        </div>
