                    ...
                    <table class="table table-condensed table-striped">
                        <thead>
                            <tr>
                                ...
                                <th>Title</th> <th>Body</th> <th>User_id</th> <th>Chapter_id</th> <th>Book_id</th> <th>Comment_count</th> <th>View_count</th> <th>Order</th> <th>Desc</th> <th>Slug</th>
                        ...
                        <tbody>
                            @foreach($topics as $topic)
                                <tr>
                                    ...
                                    <td>{{$topic->title}}</td> <td>{{$topic->body}}</td> <td>{{$topic->user_id}}</td> <td>{{$topic->chapter_id}}</td> <td>{{$topic->book_id}}</td> <td>{{$topic->comment_count}}</td> <td>{{$topic->view_count}}</td> <td>{{$topic->order}}</td> <td>{{$topic->desc}}</td> <td>{{$topic->slug}}</td>
